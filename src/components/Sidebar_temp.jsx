...
// const Sidebar_temp = () => {
//   return (
//     <div className=' h-screen text-white flex flex-col rounded-tr-xl overflow-hidden '>
...
//         alt=''/>
//       </div>
//       <div className='flex-1 overflow-y-auto px-2 space-y-4 scrollbar-thin scrollbar-thumb-transparent'>
